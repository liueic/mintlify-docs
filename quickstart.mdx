...
<AccordionGroup>
  ...
  <Accordion icon="download" title="获取代码">
    ...
    ```bash
    git clone https://github.com/liueic/PancrePal-xiaoyibao
...
<AccordionGroup>
  <Accordion icon="key" title="配置API密钥">
    ...
    ```bash
    curl https://raw.githubusercontent.com/liueic/PancrePal-xiaoyibao/refs/heads/main/env.example -o .env
    ```
