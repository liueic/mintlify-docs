---
title: "AI Gateway"
description: "多Agent统一接口平台 - 基于适配器模式的企业级AI服务网关"
---
...
AI Gateway 特别适用于以下场景：

- **多平台AI服务** - 需要同时使用多个AI平台的企业
- **平台迁移** - 需要从某个AI平台迁移到另一个平台
- **成本优化** - 需要根据使用情况选择最优的AI平台
- **风险控制** - 避免对单一AI平台的依赖
